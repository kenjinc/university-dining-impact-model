...
Finally, the last two cases (n=2) refer to the designated countries that were indexed within the dietary footprint dataset but not the university enrollment data because the entities were simply not indexed by the data source. We list them below:
