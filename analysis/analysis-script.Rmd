...
Adding aggregate variables that sum and average the pop-level decreases in water and emissions costs across scenarios in prep for multivariate regression modeling. 
...
Now, we can map the mean reduction potentials across indicators to our shapefile data to look at how changes in the water requirements and emissions costs differ spatially.
...
Now that we have generated mlr models for our baseline dietary patterns (to understand how our variable differentially predict the water and emissions costs of the standard diets for our 123 countries), we will do the same for our reduction scenarios.
...
SUM OF MEAN REDUCTIONS IN GREENHOUSE GAS EMISSIONS AMD WATER USAGE ACROSS ALL COUNTRIES AND SCENARIOS
...
SUM OF REDUCTIONS IN GREENHOUSE GAS EMISSIONS AND WATER USAGE ACROSS ALL COUNTRIES FOR MEATLESS DAY SCENARIO
...
SUM OF REDUCTIONS IN GREENHOUSE GAS EMISSIONS AND WATER USAGE ACROSS ALL COUNTRIES FOR NO DAIRY SCENARIO
...
SUM OF REDUCTIONS IN GREENHOUSE GAS EMISSIONS AND WATER USAGE ACROSS ALL COUNTRIES FOR LOW RED MEAT SCENARIO
...
SUM OF REDUCTIONS IN GREENHOUSE GAS EMISSIONS AND WATER USAGE ACROSS ALL COUNTRIES FOR NO RED MEAT SCENARIO
...
SUM OF REDUCTIONS IN GREENHOUSE GAS EMISSIONS AND WATER USAGE ACROSS ALL COUNTRIES FOR PESCETARIAN SCENARIO
...
SUM OF REDUCTIONS IN GREENHOUSE GAS EMISSIONS AND WATER USAGE ACROSS ALL COUNTRIES FOR VEGETARIAN SCENARIO
...
SUM OF REDUCTIONS IN GREENHOUSE GAS EMISSIONS AND WATER USAGE ACROSS ALL COUNTRIES FOR 2/3 VEGAN SCENARIO
...
SUM OF REDUCTIONS IN GREENHOUSE GAS EMISSIONS AND WATER USAGE ACROSS ALL COUNTRIES FOR VEGAN SCENARIO
...
TOP 10 ACROSS SCENARIOS - ALL COUNTRIES (N=123) 


Need to generate global impact dataset using mean scenario-specific anticipated reductions in kg co2e & l

ggplot(global.impact.dataset,aes(x=ghg_red,y=scenario,fill=scenario)) + 
    geom_col(color="black",size=0.25,alpha=0.66) + 
    xlab(bquote('Billion Kilograms CO'[2]*'e')) + 
    ylab("") +
    scale_fill_manual(values=c("salmon","salmon","peachpuff1","salmon","salmon","salmon","salmon","salmon","salmon")) +
    scale_y_discrete(limits=c("Mean","Meatless Day","Low Red Meat","Vegetarian","No Dairy","No Red Meat","Pescetarian","2/3 Vegan","Vegan")) +
    scale_x_continuous(,breaks=c(0,35000000000,70000000000,105000000000,140000000000,175000000000),labels=function(x)x/1000000000) +
    ggtitle("Emissions Reductions Across Scenarios") +
    theme(panel.background=element_rect(fill="white"),panel.border=element_rect(fill=NA),legend.title=element_blank(),legend.position="none")

ggplot(global.impact.dataset,aes(x=water_red,y=scenario,fill=scenario)) + 
    geom_col(color="black",size=0.25,alpha=0.66) + 
    xlab("Trillion Liters") + 
    ylab("") +
    scale_fill_manual(values=c("lightskyblue3","lightskyblue3","paleturquoise3","lightskyblue3","lightskyblue3","lightskyblue3","lightskyblue3","lightskyblue3","lightskyblue3")) +
    scale_y_discrete(limits=c("Mean","Low Red Meat","Meatless Day","No Dairy","No Red Meat","Vegetarian","2/3 Vegan","Pescetarian","Vegan")) +
    scale_x_continuous(labels=function(x)x/1000000000000) +
    ggtitle("Reductions in Water Use Across Scenarios") +
    theme(panel.background=element_rect(fill="white"),panel.border=element_rect(fill=NA),legend.title=element_blank(),legend.position="none")
